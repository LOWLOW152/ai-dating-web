...
export const questions = [
  ...
  },
  {
    ...
    type: 'semi',
    category: '消费观念',
    question: '你更接受不了对方「乱花钱不计划」还是「太抠门舍不得」？',
    field: 'spendingDealBreaker',
    inputType: 'choice',
    options: ['乱花钱不计划', '太抠门舍不得', '都接受不了', '都可以接受'],
  },
  // Q3-4 作息类型
  {
    id: 'life_2a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '作息类型',
    question: '你更接受不了对方「熬夜影响你休息」还是「早起吵醒你」？',
    field: 'sleepDealBreaker',
    inputType: 'choice',
    options: ['熬夜影响我休息', '早起吵醒我', '都接受不了', '都可以接受'],
  },
  // Q5-6 整洁程度
  {
    id: 'life_3a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '整洁程度',
    question: '你更接受不了对方「从不收拾家里乱」还是「强迫你一起收拾」？',
    field: 'tidinessDealBreaker',
    inputType: 'choice',
    options: ['从不收拾家里乱', '强迫我一起收拾', '都接受不了', '都可以接受'],
  },
  // Q7-8 压力应对
  {
    id: 'life_4a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '压力应对',
    question: '你更接受不了对方压力时「闷声不吭躲着你」还是「不停抱怨发泄」？',
    field: 'stressDealBreaker',
    inputType: 'choice',
    options: ['闷声不吭躲着我', '不停抱怨发泄', '都接受不了', '都可以接受'],
  },
  // Q9-10 家庭关系
  {
    id: 'life_5a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '家庭关系',
    question: '你更担忧对方家庭「过度干涉你们生活」还是「关系冷淡缺乏支持」？',
    field: 'familyDealBreaker',
    inputType: 'choice',
    options: ['过度干涉我们生活', '关系冷淡缺乏支持', '都担忧', '都不担忧'],
  },
  // Q11-12 生活偏好
  {
    id: 'life_6a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '生活偏好',
    question: '你更害怕生活「一眼望到头毫无新意」还是「充满不确定性让人焦虑」？',
    field: 'lifeDealBreaker',
    inputType: 'choice',
    options: ['一眼望到头毫无新意', '充满不确定性让人焦虑', '都害怕', '都不害怕'],
  },
