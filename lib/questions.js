...
export const questions = [
  ...
  },
  {
    ...
    type: 'semi',
    category: '长期爱好',
    question: '有什么事情你坚持做了三年以上？🌿',
    field: 'longTermHobby',
    inputType: 'text',
    placeholder: '可以是爱好、习惯，或者任何持续做的事',
    checkVague: true,
  },
  {
    id: 'interest_4',
  ...
  },
  {
    ...
    type: 'semi',
    category: '精神享受',
    question: '独处的时候，你脑子里经常在想什么？🌿',
    field: 'spiritualEnjoyment',
    inputType: 'text',
    placeholder: '人际关系、未来规划，或者任何你常琢磨的事',
  },
  {
    id: 'interest_6',
    type: 'semi',
    category: '消费决策',
    question: '最近一次为什么东西花了不少钱？当时怎么想的？✨',
    field: 'recentInterest',
    inputType: 'text',
    placeholder: '可以是必需品，也可以是一时冲动～',
    checkVague: true,
  },
  {
    id: 'interest_7',
    type: 'semi',
    category: '交友偏好',
    question: '你喜欢和怎样的人做朋友？🌿',
    field: 'friendPreference',
    inputType: 'text',
    placeholder: '描述一下你欣赏的朋友特质',
    checkVague: true,
  },
  {
    id: 'interest_8',
    type: 'semi',
    category: '理想日常',
    question: '如果钱和时间都不是问题，典型的一天你会怎么过？✨',
    field: 'uniqueHobby',
    inputType: 'text',
    placeholder: '从起床到睡觉，想象一下～',
    checkVague: true,
  },
  {
    id: 'interest_9',
