...
export const questions = [
  ...
  },
  {
    ...
    type: 'semi',
    category: '兴趣爱好',
    question: '你更希望另一半在这方面跟你「志同道合一起玩」，还是「各有各的爱好互相尊重」？',
    field: 'hobbyMatchPreference',
    inputType: 'choice',
    options: ['志同道合一起玩', '各有各的爱好互相尊重', '都可以看情况'],
  },
  // Q3-4 旅行偏好
  {
    id: 'interest_2a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '旅行偏好',
    question: '你更希望另一半的旅行节奏「跟你一致」，还是「不一样但能互相迁就」？',
    field: 'travelMatchPreference',
    inputType: 'choice',
    options: ['跟我一致', '不一样但能互相迁就', '都可以'],
  },
  // Q5-6 社交圈子
  {
    id: 'interest_3a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '社交圈子',
    question: '你更希望另一半是「社交活跃型（圈子大、带动你认识更多人）」，还是「社交精简型（圈子小、给你更多二人空间）」？',
    field: 'socialCirclePreference',
    inputType: 'choice',
    options: ['社交活跃型（圈子大）', '社交精简型（圈子小）', '都可以'],
  },
  // Q7-8 社交角色
  {
    id: 'interest_4a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '社交角色',
    question: '你更希望另一半在聚会里「跟你角色相似」，还是「互补搭配」？',
    field: 'socialRolePreference',
    inputType: 'choice',
    options: ['跟我角色相似', '互补搭配', '都可以'],
  },
  ...
  },
  {
    ...
    type: 'semi',
    category: '消费观念',
    question: '如果对方消费观和你不一样，比如TA更爱攒钱或更爱花钱，你会在意吗？',
    field: 'spendingConsistency',
    inputType: 'choice',
    options: ['挺在意的，希望一致', '有点在意，但可以沟通', '不太在意，可以不一样', '完全无所谓'],
  },
  // Q3-4 作息类型
  {
    id: 'life_2a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '作息类型',
    question: '如果对方作息和你不一样，比如TA是夜猫子而你要早睡，你觉得需要调整吗？',
    field: 'sleepConsistency',
    inputType: 'choice',
    options: ['需要调整，希望一致', '可以商量着来', '不用调整，各睡各的', '完全无所谓'],
  },
  // Q5-6 整洁程度
  {
    id: 'life_3a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '整洁程度',
    question: '如果对方对整洁的要求和你不一样，比如TA觉得"能找着就行"，你会觉得别扭吗？',
    field: 'tidinessConsistency',
    inputType: 'choice',
    options: ['会别扭，希望一致', '有点别扭，但可以忍', '不会别扭，各管各的', '完全无所谓'],
  },
  // Q7-8 压力应对
  {
    id: 'life_4a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '压力应对',
    question: '如果对方应对压力的方式和你不一样，比如TA想倾诉而你想独处，你会觉得有隔阂吗？',
    field: 'stressConsistency',
    inputType: 'choice',
    options: ['会有隔阂，希望一致', '会有点，但能理解', '不会，尊重差异', '完全无所谓'],
  },
  // Q9-10 家庭关系
  {
    id: 'life_5a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '家庭关系',
    question: '如果TA和家人的相处模式和你期待的差别很大，你会觉得是问题吗？',
    field: 'familyConsistency',
    inputType: 'choice',
    options: ['会觉得是问题', '有点介意，但可以接受', '不太介意，各家有各家的过法', '完全无所谓'],
  },
  // Q11-12 生活偏好
  {
    id: 'life_6a',
  ...
  },
  {
    ...
    type: 'semi',
    category: '生活偏好',
    question: '如果对方想要的生活状态和你不一样，比如TA追求变化而你想要稳定，你能接受吗？',
    field: 'lifeConsistency',
    inputType: 'choice',
    options: ['不太能接受，希望一致', '有点难，但可以磨合', '能接受，互相尊重', '完全无所谓'],
  },
