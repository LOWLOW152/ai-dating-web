...
2. 再看年龄：年轻人/中年人/老年人
3. 选择颜值类型：
   - 女性可选：清纯型、御姐型、知性型、甜美型、冷艳型、阳光型、成熟型、可爱型、优雅型、时尚型
   - 男性可选：阳光型、成熟型、斯文型、硬朗型、儒雅型、清爽型、稳重型、时尚型
4. 给出颜值评分（0-10分，客观但有温度，男性女性分开打分标准）
5. 写一句50字以内的评语，既要真诚又要给人信心

【重要】
- 如果是男性，绝对不能选"清纯型、甜美型、可爱型"等女性专属标签
- 如果是中年大叔，优先选"成熟型、稳重型、儒雅型"
- 如果看不清人脸或不是人像，返回"无法识别"
...

{
  "beauty_type": "成熟型",
  "beauty_score": 7.5,
  "ai_comment": "整体形象成熟稳重，气质内敛，给人可靠的感觉"
}`;
