                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${(result.details.facial_features / 2) * 100}%` }}
                          />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${(result.details.skin_quality / 1.5) * 100}%` }}
                          />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${(result.details.temperament / 1.5) * 100}%` }}
                          />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${(result.details.photoshop_deduction / 2) * 100}%` }}
                          />
                        </div>
            ...
            <>
              ...
              <div className="mt-8 bg-white rounded-xl shadow p-4">
                ...
                <div className="space-y-2 text-xs">
                  {BEAUTY_LEVELS.slice(0, 5).map((level) => (
                    <div key={level.label} className={`flex items-center gap-2 p-2 rounded ${level.bg}`}>
                      <span className={`font-bold ${level.color} w-16`>{level.label}</span>
                      <span className="text-gray-500 w-16">{level.min}-{level.max}分</span>
                      <span className="text-gray-600">{level.desc}</span>
                    </div>
                  ))}
                </div>              </div>
            </>
