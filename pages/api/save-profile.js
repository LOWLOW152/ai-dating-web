  ...
  try {
    ...
    const result = await sql`
      INSERT INTO profiles (
        ...
        spending_habit, spending_deal_breaker, sleep_schedule, sleep_deal_breaker,
        tidiness, tidiness_deal_breaker, stress_response, stress_deal_breaker,
        family_relationship, family_deal_breaker, life_preference, life_deal_breaker,
        ...
        ${answers.spendingHabit}, ${answers.spendingDealBreaker}, ${answers.sleepSchedule}, ${answers.sleepDealBreaker},
        ${answers.tidiness}, ${answers.tidinessDealBreaker}, ${answers.stressResponse}, ${answers.stressDealBreaker},
        ${answers.familyRelationship}, ${answers.familyDealBreaker}, ${answers.lifePreference}, ${answers.lifeDealBreaker},
